...
Answer.create(label: "Yes",
              value: ",5,",
              hint: "If the contest is organized by an external agency, <span class='orange'>please make a request</span>.",
...
Answer.create(label: "No",
              value: ",6,",
              hint: "If the contest is organized by an external agency which is not under contract with Ubisoft, <span class='orange'>please make a request</span>.",
              hint_header: "<span class='orange'>It's request time</span>",
              hint_icon: "<i class='fas fa-sync-alt white'></i>",
              answer_type: "radio",
              order: 6,
...
Answer.create(label: "Other",
              value: ",25,",
              hint: "If the usecases is <br>other<br>, <span class='orange'>please make a request</span>.",
              hint_header: "<span class='orange'>It's request time</span>",
              hint_icon: "<i class='fas fa-sync-alt white'></i>",
              answer_type: "checkbox",
              order: 25,
