...
Answer.create(label: "Agency 1", value: ",a chargé la société #{q4.answers.where(order: 7).value} de collecter et traiter vos données personnelles,",
              hint: nil, hint_header: nil, answer_type: "select", order: 7, question: q4)
Answer.create(label: "Agency 2", value: ",a chargé la société #{q4.answers.where(order: 8).value} de collecter et traiter vos données personnelles,",
